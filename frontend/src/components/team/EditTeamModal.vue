      ...
      <form @submit.prevent="handleSubmit" class="p-6 space-y-4">
        ...
        <div>
           ...
           <textarea 
             ...
             rows="3"
             class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all resize-none"
             :disabled="loading"
           ></textarea>
        </div>
...
import type { TeamDetail, UpdateTeamDto } from '@/types/Team'
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await teamsStore.updateTeam(props.team.id, dto)
    emit('updated')
    emit('close')
  } catch (e: any) {
